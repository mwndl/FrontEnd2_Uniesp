...
function listarAprovados(estudantes) {
    for (let estudante of estudantes) {
        let media = estudante.notas.reduce((a, b) => a + b, 0) / estudante.notas.length;
        if (media >= 7) {
            console.log("Nome: " + estudante.nome + "| Média Aritmética: " + media.toFixed(2) + "| Curso: " + estudante.curso);
        }
    }
}
